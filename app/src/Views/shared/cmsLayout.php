...
<div class="container-fluid cms-shell">
    <div class="row">
        <aside class="col-12 col-md-3 col-lg-2 cms-sidebar">
            <div class="cms-brand-block">
                <a href="/cms" class="cms-brand">
                    <span class="cms-brand-mark">HF</span>
                    <span class="cms-brand-copy">
                        <span class="cms-brand-title">Festival CMS</span>
                        <span class="cms-brand-subtitle">Admin control</span>
                    </span>
                </a>
            </div>

            <nav class="mt-3">
                <p class="cms-nav-section-label">Core</p>
                ...
                <p class="cms-nav-section-label">Session</p>
                <a href="/" class="cms-nav-link">
        ...
        <main class="col-12 col-md-9 col-lg-10 cms-main px-0">
            <header class="cms-topbar px-4 py-3 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <span class="cms-topbar-subtitle">Festival administration workspace</span>
                </div>
                <span class="cms-topbar-role">Administrator</span>
            </header>
...
<script src="/js/cms/file-input.js"></script>
<script>
    lucide.createIcons();
</script>
</body>
