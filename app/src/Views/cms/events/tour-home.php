...
<div class="container py-4">
    ...
    <form method="POST" action="/cms/events/tour-home" class="card" data-tour-page-slug="<?= htmlspecialchars($pageSlug ?? 'tour-home') ?>">
        <div class="card-body">
            <div class="accordion cms-accordion" id="tourHomeAccordion">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="tourHomeHeading1">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#tourHomeCollapse1" aria-expanded="true" aria-controls="tourHomeCollapse1">
                            Header
                        </button>
                    </h2>
                    <div id="tourHomeCollapse1" class="accordion-collapse collapse show" aria-labelledby="tourHomeHeading1" data-bs-parent="#tourHomeAccordion">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="tourHomeHeading2">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#tourHomeCollapse2" aria-expanded="false" aria-controls="tourHomeCollapse2">
                            Stops on the Tour
                        </button>
                    </h2>
                    <div id="tourHomeCollapse2" class="accordion-collapse collapse" aria-labelledby="tourHomeHeading2" data-bs-parent="#tourHomeAccordion">
                        <div class="accordion-body">
                            <div class="mb-3">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="tourHomeHeading3">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#tourHomeCollapse3" aria-expanded="false" aria-controls="tourHomeCollapse3">
                            Discover Section
                        </button>
                    </h2>
                    <div id="tourHomeCollapse3" class="accordion-collapse collapse" aria-labelledby="tourHomeHeading3" data-bs-parent="#tourHomeAccordion">
                        <div class="accordion-body">
                            <div class="mb-3">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="tourHomeHeading4">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#tourHomeCollapse4" aria-expanded="false" aria-controls="tourHomeCollapse4">
                            Meet Your Guides Section
                        </button>
                    </h2>
                    <div id="tourHomeCollapse4" class="accordion-collapse collapse" aria-labelledby="tourHomeHeading4" data-bs-parent="#tourHomeAccordion">
                        <div class="accordion-body">
                            <div class="mb-3">
