const quillForm = document.querySelector('form[data-quill-form="1"]');
const quillEditors = [];

function initializeQuillEditors() {
    if (!quillForm || typeof Quill === 'undefined') {
        return;
    }
    ...
    const richTextAreas = quillForm.querySelectorAll('textarea[data-quill="1"]');
